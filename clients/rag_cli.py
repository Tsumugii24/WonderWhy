...
#   todo: topk 
def query_knowledge_base(query, kb_name, only_images):
    """
    ...
    Args:
        ...
        only_images(bool): Flag to only search imgs.
    Returns:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--only_images", action="store_true", help="Flag to only search imgs.")

    args = parser.parse_args()

    try:
        result = query_knowledge_base(args.query, args.kb_name, args.only_images)
